...
interface View {
     ...
     */
    @UiThread fun onManifestChanged(manifest: StorageReference) {}
     ...
     */
    @UiThread fun onStateChanged(reference: StorageReference, state: Array<Update>) {}
     ...
     */
    @UiThread fun onErc20Changed(reference: StorageReference, state: Array<OwnerTokens>) {}
     ...
     */
    @UiThread fun onAccountsChanged(accounts: Accounts) {}
     ...
     */
    @UiThread fun onAccountCreated(account: Account)
     ...
     */
    @UiThread fun onAccountImported(account: Account)
     ...
     */
    @UiThread fun onAccountDeleted(account: Account)
     ...
     */
    @UiThread fun onAccountReplaced(old: Account, new: Account)
     ...
     */
    @UiThread fun onBip39Available(account: Account, bip39: BIP39Mnemonic) {}

    /**
     * Called when a QR code scan has been cancelled by the user.
     */
    @UiThread fun onQRScanCancelled()
     ...
     */
    @UiThread fun onQRScanAvailable(data: String)
     ...
     */
    @UiThread fun onPaymentCompleted(
        payer: Account,
