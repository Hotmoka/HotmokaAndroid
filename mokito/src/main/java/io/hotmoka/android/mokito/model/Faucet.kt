...
class Faucet: Account {
    ...
    constructor(reference: StorageReference, maxFaucet: BigInteger, balance: BigInteger, isAccessible: Boolean):
            super(reference, "Faucet", Entropies.of(ByteArray(16)),"", balance, isAccessible, Coin.MOKA) {
